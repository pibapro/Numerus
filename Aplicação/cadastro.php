...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <p>Os campos com * são de preencimento obrigatório</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-tabs">
          <li class="active">
            <a href="#DadosPessoais" data-toggle="tab">Dados Pessoais</a>
          </li>
          <li>
            <a href="#DadosEclesiasticos" data-toggle="tab">Dados eclesiásticos</a>
          </li>
          <li>
            <a href="#">Messages</a>
          </li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group ">
                        ...
                        <input class="form-control" id="InputNumEndereco" name="InputNumEndereco" placeholder="Digite o Número" type="number" data-toggle="tooltip" data-placement="bottom" title="Informe o número de sua casa.">
                      </div>
                    </div>
    ...
    <div class="row">
      <div class="col-md-12 text-right">
        <p>Numerus - Sistema eclesiástico [Versão 0.1]</p>
      </div>
    </div>
